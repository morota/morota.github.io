...
\item [{\bf 38}.] Baba T, Momen M, Campbell MT, Walia H, and \textbf{\underline{Morota G}}. Multi-trait random regression models increase genomic prediction accuracy for a temporal physiological trait derived from high-throughput phenotyping. \emph{PLOS ONE}.

\item [{\bf 38}.] Paul P, Dhatt B, Sandhu J, Hussain W, Irvin L, \textbf{\underline{Morota G}}, Staswick P, and Walia H. Divergent phenotypic response of rice accessions to transient heat stress during early seed development is linked to the rate of endosperm cellularization. \emph{Plant Direct}. 
...
\vspace{0.5cm}
10 first author, 14 co-author, and 9 senior author publications (20 publications as a PI)\\

\section{\sc 2019}
\begin{list1}

  
\item  [{\bf 33}.] Momen M, Campbell MT, Walia H, and \textbf{\underline{Morota G}}. Utilizing trait networks and structural equation models as tools to interpret multi-trait genome-wide association studies. \emph{Plant Methods}. In press. doi: \textcolor{blue}{\href{https://doi.org/10.1101/553008}{10.1101/553008}}
...
%\item SmartFarm Innovation Network \$349,150  \hfill VT\\
%PI: Robin White  \hfill \textbf{August 26, 2019 - August 30, 2020}\\
