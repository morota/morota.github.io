...
\begin{list1}
  ...
  \item  [{\bf 67}.] Baba T, \textbf{\underline{Morota G}}, Kawakami J, Goto Y, Oka T, Masuda Y, Brito LF, Cockrum RR, and Kawahara T. 2023. Longitudinal genome-wide association analysis using a single-step random regression model for height in Japanese Holstein cattle.  \emph{JDS Communications}. In press. doi: \textcolor{blue}{\href{https://doi.org/10.3168/jdsc2022-0347}{10.3168/jdsc2022-0347}} 
