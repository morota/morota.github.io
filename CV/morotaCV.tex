...
\name{Gota Morota \hspace{12.2cm} June 2026 \vspace*{.1in}}
...
\begin{list2}
  ...
  \item  Genetics Society of America. 2016 - 2021, 2026 - Present
  \vspace{0.3cm}
...
\begin{itemize}
  \item {\bf G3: Genes, Genomes, Genetics} \hfill {\bf January 2026 - Present}
    \begin{itemize}
...
\underline{Editorial Board}
 \vspace{.2cm}
\begin{itemize}
    \item {\bf Brazilian Journal of Biometrics} \hfill {\bf January 2023 - December 2026}
...
\begin{itemize}
    \vspace{.1cm}
\item  Number of manuscripts reviewed per journal (revised versions are not counted): Agronomy Journal (1), Animal (3), Animal Genetics (7), Animal Production Science (3), Animal Science Journal (3), Bioinformatics (5), Bioinformatics Advance (1), BMC Bioinformatics (3), BMC Genetics (6), BMC Genomics (3), BMC Genomic Data (1), BMC Plant Biology (1), Computers and Electronics in Agriculture (3), Crop Science (3), DNA Research (1),  Euphytica (1), Functional \& Integrative Genomics (1), Frontiers in Animal Science (2), Frontiers in Genetics (8), Frontiers in Plant Science (2), G3: Genes, Genomes, Genetics (6), Genetics (3), Genetics Selection Evolution (11), Genome (1), Heredity (3), Horticulture Research (2), JDS Communications (3), Journal of Agricultural, Biological, and Environmental Statistics (1), Journal of Animal Breeding and Genetics (11), Journal of Animal Science (29), Journal of Animal Science and Biotechnology (3), Journal of Dairy Science (18), Journal of the Royal Statistical Society (1), Livestock Science (7), Meat Science (2), Nature Communications (1), New Phytologist (1), PeerJ (1), Plant Breeding (1), Plant Communications (1), PLOS ONE (6), Poultry Science (3), Preventive Veterinary Medicine (1), Rice Science (1), Scientia Agricola (3), Scientific Reports (2), Statistics in Medicine (1), Theoretical and Applied Genetics (12), The Crop Journal (1), Theoretical Population Biology (1), The Plant Genome (3), The Plant Journal (1), The Plant Phenome Journal (4), The R Journal (1), Translational Animal Science (2)  
  \vspace{.1cm}
  \item Number of manuscripts reviewed per year (revised versions are not counted): 2025 (11), 2024 (20), 2023 (16), 2022 (18), 2021 (28), 2020 (19), 2019 (27), 2018 (19), 2017 (20), 2016 (10), 2015 (10), 2014 (6), 2013 (1), 2012 (1)
\end{itemize}
% Total: 113
...
Zhang Z, Ha DS, \textbf{\underline{Morota G}}, and Shin S. Behavior-specific filtering for enhanced pig behavior classification in precision livestock farming. 12th International Conference on Signal, Image Processing and Multimedia (SPM 2025). Toronto, Canada. July 19-20, 2025. 
https://arxiv.org/abs/2507.21021
https://dx.doi.org/10.2139/ssrn.5369329
https://ssrn.com/abstract=5369329
https://cseit2025.org/spm/index



Petrini J, Cesar ASM, Silva-Vignato B, Garcia IS, Gervásio IC, Cardoso  TF, Andrade BGN, Morota G, Spangler  ML, Neto AZ , Coutinho LL, de Almeida Regitano LC, and Mourão GB. Enhancing genomic prediction accuracy through the use of functional variants in a Nellore cattle population.

Ouinten Y, Medrouh B, Boussaid K, Kerzabi R, Ranebi D, Medjeber M, Khenfer B, Hakem A, and Morota G. Morphometric and genetic insights into three Algerian sheep breeds using microsatellite markers: Characterization of three main Algerian sheep breeds. Revue d’élevage et de médecine vétérinaire des pays tropicaux
https://revues.cirad.fr/index.php/REMVT/index

Mann SS, Shehada H, Bhatt S, Amorim ST, Ha DS, Morota, G, and Shin S. DeepCattle: Empowering Computer Vision and AI for Accurate Weight Prediction in Beef Cattle
...
\begin{list1}
  ...
  \item  [{\bf 2}.] Tang Z, Wang J, De Castro A, Zhang Y, Primo VB, Bernardino ABM, \textbf{\underline{Morota G}}, Wang X, Chebel RC, and Yu H. Can 3D point cloud data improve automated body condition score prediction in dairy cattle?  \emph{arXiv} doi: \textcolor{blue}{\href{https://doi.org/10.48550/arXiv.2601.22522}{10.48550/arXiv.2601.22522}}

  \vspace{0.5cm}

  \item  [{\bf 1}.]  Wang J, De Castro A,  Zhang Y, Borsatto LB, Guo Y, Primo VB, Bernardino ABM, \textbf{\underline{Morota G}}, Chebel RC, and Yu H. Evaluating transfer learning strategies for improving dairy cattle body weight prediction in small farms using depth-image and point-cloud data. \emph{arXiv} doi: \textcolor{blue}{\href{https://doi.org/10.48550/arXiv.2601.01044}{10.48550/arXiv.2601.01044}}
...
\centering
 ...
 Peer-reviewed research journal articles  & 44 & 53 & 97 \\  \hline
 Peer-reviewed review journal articles  & 5 & 3 & 8 \\  \hline
 Peer-reviewed conference proceedings & 1 & 12 & 13 \\ \hline
 Other scholarly publications & 1 & 1 & 2 \\ \hline
 Total & 52 &  70 & 122 \\ \hline
  \end{tabular}
...
\begin{list1}
  ...
  \item  [{\bf 97}.] Mann SS, Shehada HK, Amorim ST, Ha DS, Morota G, and Shin S. 2026. Light attention encoder-decoder for cattle body segmentation and body weight estimation. \emph{Animals}. \textbf{16}:1773. doi: \textcolor{blue}{\href{https://doi.org/10.3390/ani16121773}{10.3390/ani16121773}} 

  \vspace{0.5cm}

  \item  [{\bf 96}.] Amorim ST, Retallick KJ, Garcia A, Iba\~{n}ez-Escriche N, and \textbf{\underline{Morota G}}. 2026. Genetic heterogeneity of residual variance for growth traits in American Angus cattle. \emph{Journal of Animal Science}. Early view. doi: \textcolor{blue}{\href{https://doi.org/10.1093/jas/skag167}{10.1093/jas/skag167}} 


  \vspace{0.5cm}


  \item  [{\bf 95}.] Bi Y, Huang Y, Yu H, and \textbf{\underline{Morota G}}. 2026. Impact of trait measurement error on quantitative genetic analysis of computer vision derived traits. \emph{Genes}. \textbf{17}:506. doi: \textcolor{blue}{\href{https://doi.org/10.3390/genes17050506}{10.3390/genes17050506}} 

  \vspace{0.5cm}

  \item [{\bf 94}.]  Habimana V, Nguluma AS, Nziku ZC, Ekine-Dzivenu CC, \textbf{\underline{Morota G}}, Mrode R, and Chenyambuga SW. 2026. Assessing genetic variation and phylogenetic relationship of dairy cattle breeds reared in Tanga region, Tanzania using HSF1 and HSPA6 genes responsible for heat tolerance \emph{International Journal of Livestock Production}. \textbf{17}:45-57. doi: \textcolor{blue}{\href{https://doi.org/10.5897/IJLP2026.0885}{10.5897/IJLP2026.0885}} 

  \vspace{0.5cm}


\item [{\bf 93}.] Silva CM,  Signorini VS,  Mezzomo HC, Ribeiro JPO, Lima GW, Portes MF, Corredo LP, Olivoto T, \textbf{\underline{Morota G}}, and Nardino M. 2026. Optimizing indirect selection of tropical wheat genotypes using high-throughput longitudinal phenotyping and trait relationships. \emph{Remote Sensing Applications: Society and Environment}. \textbf{41}:101892. doi: \textcolor{blue}{\href{https://doi.org/10.1016/j.rsase.2026.101892}{10.1016/j.rsase.2026.101892}} 

\vspace{0.5cm}

\item [{\bf 92}.] Amorim ST, Retallick KJ, Garcia A, Iba\~{n}ez-Escriche N, and \textbf{\underline{Morota G}}. 2026. Genetic heterogeneity of residual variance for foot score traits in American Angus cattle. \emph{Journal of Animal Breeding and Genetics}. \textbf{143}:68-78. doi: \textcolor{blue}{\href{https://doi.org/10.1111/jbg.12949}{10.1111/jbg.12949}}
...
\begin{list1}
  ...
  \item [{\bf 91}.]  Yoshioka H, \textbf{\underline{Morota G}}, and Iwata H. 2025. Reciprocal BLUP: A predictability-guided multi-omics framework for plant phenotype prediction. \emph{Plants}. \textbf{15}:17. doi: \textcolor{blue}{\href{https://doi.org/10.3390/plants15010017}{10.3390/plants15010017}}

  \vspace{0.5cm}

  \item [{\bf 90}.] Habimana V, Ekine-Dzivenu CC, Nguluma AS,  Nziku ZC, \textbf{\underline{Morota G}}, Chenyambuga SW, and Mrode R. 2025. Estimation of genetic parameters for physiological and milk production traits of Holstein Friesian crossbreds reared in Tanzania. \emph{International Journal of Livestock Production}. \textbf{16}:9-18. doi: \textcolor{blue}{\href{https://doi.org/10.5897/IJLP2025.0874}{10.3168/10.5897/IJLP2025.0874}}

  \vspace{0.5cm}

  \item [{\bf 89}.] Morales AG, Amorim ST, Lizana C,  Pulido RG, Hanigan MD, Cockrum RR, and \textbf{\underline{Morota G}}. 2025. Incorporating heterosis effects enhances genetic evaluations for milk production and functional traits in Chilean crossbred dairy cows. \emph{Journal of Dairy Science}. \textbf{108}:13565-13576. doi: \textcolor{blue}{\href{https://doi.org/10.3168/jds.2025-26445}{10.3168/jds.2025-26445}}

 
  \vspace{0.5cm}

  \item  [{\bf 88}.] Suela MM, Azevedo CF, Nascimento ACC, \textbf{\underline{Morota G}}, Lopes da Silva F, Nizio GM  Giasson F, and Nascimento M. 2025. Using Structural Equation Models to Interpret Genome-Wide Association Studies for Morphological and Productive Traits in Soybean [Glycine max (L.) Merr.].  \emph{Plants}. \textbf{14}:3015. doi: \textcolor{blue}{\href{https://doi.org/10.3390/plants141930155}{10.3390/plants14193015}}

  \vspace{0.5cm}

  \item  [{\bf 87}.] Silva CM, Kunduru B, Bokros N, Tabaracci K, Oduntan Y, Brar MS, Kumar R, Stubbs CJ, Nardino M, McMahan CS, DeBolt S, Robertson DJ, Sekhon RS, and \textbf{\underline{Morota G}}. 2025. Genomic prediction of stalk lodging resistance and the associated intermediate phenotypes in maize using whole-genome resequence and multi-environmental data. \emph{The Plant Genome}. \textbf{18}:e70125. doi: \textcolor{blue}{\href{https://doi.org/10.1002/tpg2.70125}{10.1002/tpg2.70125}}

  \vspace{0.5cm}

  \item  [{\bf 86}.] Bi Y, Huang Y, Xuan J, and \textbf{\underline{Morota G}}. 2025. Industry-scale prediction of video-derived pig body weight using efficient convolutional neural networks and vision transformers. \emph{Biosystems Engineering}.  \textbf{257}:104243. doi: \textcolor{blue}{\href{https://doi.org/10.1016/j.biosystemseng.2025.104243}{https://doi.org/10.1016/j.biosystemseng.2025.104243}}

  \vspace{0.5cm}

  \item [{\bf 85}.] Gon\c{c}alves MTV, Dias KODG, da Silva Pereira G, Ferreira PHS, Barbosa MHP, \textbf{\underline{Morota G}}, and Peternelli LA. 2025. Single-step genomic best linear unbiased predictions of sugarcane genotype performance. \emph{Euphytica}. \textbf{221}:131. doi: \textcolor{blue}{\href{https://doi.org/10.1007/s10681-025-03577-6}{10.1007/s10681-025-03577-6}}

  \vspace{0.5cm}

  \item  [{\bf 84}.] Suela MM, Azevedo CF, Nascimento ACC, Caixeta ET, de Oliveira ACB, \textbf{\underline{Morota G}}, Nascimento M. 2025. Structural equation modeling and genome-wide selection for multiple traits to enhance Arabica coffee breeding programs. \emph{Agronomy}. \textbf{15}:1686. doi: \textcolor{blue}{\href{https://doi.org/10.3390/agronomy15071686}{10.3390/agronomy15071686}}
...
\begin{list1}
  ...
  \item  [{\bf 8}.] Ouinten Y, Medrouh B, Lafri I, Boussaid K, Brahimi M, Rebhi H, and \textbf{\underline{Morota G}}. 2026. Genetic diversity of sheep breeds in the Maghreb using microsatellite markers: A systematic review. Genetic and Biodiversity Journal. \textbf{10}:92-106. doi: \textcolor{blue}{\href{https://doi.org/10.46325/cdct9r92}{10.46325/cdct9r92}}

  \vspace{0.5cm}

  \item  [{\bf 7}.] \textbf{\underline{Morota G}}, Lee, HJ, Lee SH, Park HB, and Onogi A. 2026. Artificial intelligence in animal breeding and genetics: applications, opportunities, and challenges. \emph{Animal Frontiers}. \textbf{16}:99-107. doi: \textcolor{blue}{\href{https://doi.org/10.1093/af/vfaf058}{10.1093/af/vfaf058}}
...
\vspace{1.0cm}
\section{\sc Other scholarly publications}
\vspace{1.0cm}

\section{\sc 2026}
\begin{list1}

\item [\bf{2}.] {\bf \underline{Morota G}}, Kawakatsu T, Soma F, Iwata H, and Uga Y. 2026. Breeding $\times$ Omics. \emph{Breeding Research}. \textbf{28}:66-69 (2026). doi: \textcolor{blue}{\href{https://doi.org/10.1270/jsbbr.28.W01}{10.1270/jsbbr.28.W01}}   
...
\vspace{0.5cm}
29 domestic and 25 international \\
\noindent
...
\begin{list2}
  ...
  \item [{\bf 54}.]  Evaluating the impact of trait measurement error on genetic analysis of computer vision-based phenotypes. Advances in statistics and ML for breeding studies: From trait analysis to genomic prediction saession. The 19th International Joint Conference on Computational and Financial Econometrics (CFE) and Computational and Methodological Statistics (CMStatistics) (CFE-CMStatistics 2025).  Birkbeck, University of London, London, UK. December 13-15, 2025.
  
  \vspace{0.5cm}

  
  \item [{\bf 53}.] Evaluating the impact of trait measurement error on genetic analysis of computer vision-based phenotypes. Methods and Practice in Agricultural Analytics. Biometrics in the Bush Capital (BIBC2025). The Australasian Region Biometrics Conference. National Film and Sound Archive of Australia, Canberra, Australia. November 24-28. 2025,

  \vspace{0.5cm}

  \item [{\bf 52}.] Current status and prospects of breeding in animal science. Webinar on Breeding Science. Division of Breeding Science, Science Council of Japan. Online. October 24, 2025. %畜産における育種の現状と展望

  \vspace{0.5cm}

   \item [{\bf 51}.] Digital innovations in quantitative genetic analysis of image-derived traits. Animal Bio Bigdata Session. Chungnam National University Conference of Advanced Technology (CCAT). Chungnam National University, Daejeon, South Korea. September 25, 2025. 


   \vspace{0.5cm}

   \item [{\bf 50}.]  A Journey to reconsider what we take for granted: The value of experiencing minority status abroad. Diversity \& Inclusion (D\&I) Promotion Seminar. The 148th Japanese Society of Breeding Meeting. Sapporo Convention Center, Sapporo, Hokkaido, Japan. September 10-11. 2025. % “当たり前”を見直す旅へ：海外で“マイノリティ”を経験する意義 
  ...
  \item [{\bf 48}.]  Addressing challenges in agricultural biology through biometric approaches.  Research Center for Agricultural Information Technology, National Agriculture and Food Research Organization (NARO), Tsukuba, Ibaraki, Japan. July 7. 2025.  %生物測定学による農業生物学の課題解決に向けた取り組み


  \vspace{0.5cm}

  \item [{\bf 47}.]  Animal Breeding \& Genetics x Data Science / AI. Special Seminar. Institute of Livestock and Grassland Science, National Agriculture and Food Research Organization (NARO), Tsukuba, Ibaraki, Japan. April 14. 2025. %動物遺伝育種学 x データ科学・AI 
...
\begin{list2}
  ...
  \item [{\bf 22}.] From cornfields to the red gate. Agricultural and Environmental Biology Special Seminar. Graduate School of Agricultural and Life Sciences, The University of Tokyo, Bunkyo, Tokyo, Japan. October 22, 2025. 
  ...
  \item [{\bf 20}.] Single-step genomic best linear unbiased predictions in sugarcane. The 148th Japanese Society of Breeding Meeting. Sapporo Convention Center, Sapporo, Hokkaido, Japan. September 10-11. 2025. %サトウキビにおける系譜およびゲノム情報を用いたBLUPによる育種価予測


  \vspace{0.5cm}

  \item [{\bf 19}.] Public plant breeding programs in the USA. Sustainable agriculture and its future. 2025 The University of Tokyo Sarabetsu Satellite Campus Public Seminar. SaraPark Hall, Sarabetsu, Hokkaido, Japan. June 10, 2025. % 米国の大学における植物育種プログラムの現状. 持続可能農業とその未来. 令和7年度東京大学更別村サテライトキャンパス公開講座. 北海道更別村地域創造複合施設（サラパーク）ホール, 更別村, 北海道.
...
\begin{list2}
  ...
  \item  [{\bf 21}.]  Genetic heterogeneity of residual variance in plants and animals. Laboratory of Biometry and Bioinformatics. Department of Agricultural and Environmental Biology. The University of Tokyo, Bunkyo, Tokyo, Japan. June 24. 2026. 
...
\begin{list2}
  ...
  \item  [{\bf 20}.] Year-end summary updates. Seminar in Agricultural Biology. Laboratory of Biometry and Bioinformatics. Department of Agricultural and Environmental Biology. The University of Tokyo, Bunkyo, Tokyo, Japan. December 17. 2025. % 農業生物学研究演習

  \vspace{0.5cm}


  \item  [{\bf 19}.] What can be done with Agricultural Biology x Data Science/AI? Agricultural Biology Major Lunch Seminar. The University of Tokyo, Meguro, Tokyo, Japan. April 28. 2025. % 農業生物学 x データ科学・AIで何ができる？　農業生物学専修ランチセミナー
...
\vspace{0.4cm}
\begin{list2}
  \item Biometrics \hfill {\bf A Semester, 2025} \\ % バイオメトリックス
  Faculty of Agriculture \& Faculty of Science \\ % 農学部 & 理学部生物情報科学科／Faculty of Science Bioinformatics and Systems Biology
  19  participants 
\end{list2}
...
\begin{list2}
  \item Practice in Basic Field Agrobiology - April 15 \hfill {\bf S Semester, 2026} \\ % %フィールド農学基礎実習 
  Faculty of Agriculture \\ %農学部 
  Topic: Design of experiments % 圃場試験実習、試験区設定
\end{list2}
...
\begin{list2}
  \item  Play and Learn! Exploring Genetics and Data Science  \hfill {\bf A1 Term, 2025} \\ % 全学自由研究ゼミナール「遊んで学ぶ！ゲノム育種ゲームでひもとく遺伝学とデータ科学」
  with the Genome Breeding Game \\
...
\begin{list2}
  \item Introduction to Agricultural and Environmental Biology - 11/20 \hfill {\bf A Semester, 2025} \\ % Introduction to Agricultural and Environmental Biology 
  Graduate School of Agricultural and Life Sciences \\ % 農学生命科学研究科
  Topic: Decoding mixed model equations 
\end{list2}
...
\begin{list2}
  \item Experiments in Advanced Applied Biology - 10/2, 10/3, 10/9, 10/10 \hfill {\bf A Semester, 2025} \\ % 応用生物学専門実験
  Faculty of Agriculture \\ %農学部 
  Topics: Deep learning for image analysis and Plant breeding simulation game
\end{list2}
...
\begin{list2}
  \item Practice in Intensive Field Agrobiology \hfill {\bf S Semester, 2025} \\ % %フィールド農学集中実習 
  Faculty of Agriculture \\ %農学部 
...
\begin{list2}
  \item Advanced Biometrics  \hfill {\bf S Semester, 2025} \\  % 生物測定学特論
  Graduate School of Agricultural and Life Sciences \\ % 農学生命科学研究科
...
\begin{list2}
  \item Mathematical Sciences in Agriculture - July 11 \hfill {\bf S Semester, 2025} \\ % 農学現象の数理科学的理解
  Graduate School of Agricultural and Life Sciences \& Faculty of Agriculture \\ %農学生命科学研究科・農学部 
  Topic: Quantitative genetics modeling as a basis of animal and plant breeding % 動植物の選抜育種を支える量的遺伝モデリング
\end{list2}

\vspace{0.4cm}

\begin{list2}
  \item Practice in Basic Field Agrobiology - April 16 \hfill {\bf S Semester, 2025} \\ % %フィールド農学基礎実習 
  Faculty of Agriculture \\ %農学部 
  Topic: Design of experiments % 圃場試験実習、試験区設定
\end{list2}
...
\begin{list2}
  \item Experiments in Applied Biology I - 5/16, 5/22, 5/29 \hfill {\bf S Semester, 2025} \\ % %応用生物学基礎実験I
  Faculty of Agriculture \\ %農学部 
  Topic: Image analysis, QTL mapping, and GWAS
\end{list2}
...
\vspace{0.4cm}
 ...
 Faculty of Agriculture \& Faculty of Science \\ % 農学部
 Topic: Practical applications of effective data-driven breeding % 具体的な応用例 - データ駆動型による効率的・効果的な農業・育種
\end{list2}
...
\vspace{0.4cm}
 ...
 Graduate School of Agricultural and Life Sciences \\ 
 Topic: Data science in agriculture
\end{list2}
...
\vspace{0.4cm}
 ...
 Topic: Introduction to genome to phenome
 \end{list2}
...
{\bf Japan Biological Informatics Consortium (JBIC)}, Online.  % バイオ産業情報化コンソーシアム データサイエンス講習会
\vspace{.01pt}

Co-Instructor  \\
Data Science Workshop - [\textcolor{blue}{\href{https://www.jbic.or.jp/jbic/wp-content/uploads/2026/02/260312-13data_science.pdf}{WWW}}] 
 \hfill {\bf March 13, 2026}  \\
20 participants
...
{\bf Niigata University}, Niigata city, Niigata, Japan
\vspace{.01pt}

Co-Instructor  \\
Advanced Agricultural Technologies - [\textcolor{blue}{\href{https://sites.google.com/ut-biomet.org/aatniigatau/}{WWW}}] %先端的農業技術論
\hfill {\bf November 10-12, 2025} \\
8 participants 
...
\vspace{0.5cm}
\section{\sc Dissertation Committees}

\begin{flushleft}
  \hspace{0.2cm} \underline{Ph.D Dissertation Evaluation Committees}
  \end{flushleft}
  \begin{enumerate}

    \item [8.] Haruka Sano  \hfill 2026 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisors: Hiroyoshi Iwata / Masaru Fujimoto

\vspace{0.3cm}

    \item [7.] Fangming Zhu  \hfill 2026 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisors: Hiroyoshi Iwata / Masaru Fujimoto

    \vspace{0.3cm}

    \item [6.] Hayato Yoshioka  \hfill 2026 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisor: Hiroyoshi Iwata

    \vspace{0.3cm}

    \item [5.] Sylvain Grison  \hfill 2026 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisor: Wei Guo

    \vspace{0.3cm}

    \item [4.] Hideto Mochizuki \hfill 2026 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisor: Hiroyoshi Iwata

    \vspace{0.3cm}

  \item [3.] Mashiro Okada \hfill 2025 \\
    Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
    Major advisor: Hiroyoshi Iwata
  
    \vspace{0.3cm}

  \item [2.] Kengo Sakurai \hfill 2025 \\
   Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
   Major advisor: Hiroyoshi Iwata

  \vspace{0.3cm}

  \item [1.] Kosuke Hamazaki \hfill 2023 \\
   Department of Agricultural and Environmental Biology,  University of Tokyo \\ 
   Major advisor: Hiroyoshi Iwata
...
% WCGALP Permanent Committee



\begin{flushleft}
  \hspace{0.3cm} \underline{Societies}
\end{flushleft}
%\vspace{0.5cm}
\begin{list2}

  \item JSB Representative to the Association of Japanese Agricultural Scientific Societies \\ % 農学会担当
  Executive Committee \\
  Japanese Society of Breeding \hfill \textbf{2026 - Present}

  \vspace{0.3cm}

  \item Press Announcement/Press Release Coordinator \\ % 記者発表担当
  Executive Committee \\
  Japanese Society of Breeding \hfill \textbf{2026 - Present}
...
\item  Expert Officer, Science and Technology Experts Network \\ %専門調査員、科学技術専門家ネットワーク、文部科学省  科学技術・学術政策研究所  科学技術予測・政策基盤調査研究センター 
Center for S\&T Foresight and Indicators \\
National Institute of Science and Technology Policy \\
Ministry of Education, Culture, Sports, Science and Technology (MEXT) \hfill \textbf{2026 - Present}
...
\begin{list2}
  ...
  \item  Information Ethics Committee   \\ % (研究科情報倫理審査会)
...
\begin{list2}
  ...
  \item Undergraduate Education Committee \\ % 学部教育会議委員 director of undergraduate studies / Undergraduate Program Director
  Agricultural Biology Major, Faculty of Agriculture  \\ The University of Tokyo   \hfill \textbf{2026-2027}\\

  \vspace{0.3cm}


 
  \item  Shingaku Sentaku (Admissions to Senior Division) Task Force. \\ % 進学選択タスクフォース
  Agricultural Biology Major, Faculty of Agriculture  \\ The University of Tokyo   \hfill \textbf{2026-Present}\\

  \vspace{0.3cm}



  \item Practice in Intensive Field Agrobiology Committee  \\ % %フィールド農学集中実習委員（旧農家実習委員） Hands-on Farm Work Experience Committee
...
\begin{list2}
  ...
  \item The 149th Japanese Society of Breeding Meeting. Ibaraki University, Mito, Ibaraki, Japan. March 21-22, 2026. 
