...
\begin{list2}
  \item  Play and Learn! Exploring Genetics and Data Science with the Genome Breeding Game \hfill {\bf A1 Term, 2025} \\ % 全学自由研究ゼミナール「遊んで学ぶ！ゲノム育種ゲームでひもとく遺伝学とデータ科学」
...
\begin{list2}
  ...
  Deep learning for image analysis and Plant breeding simulation game
\end{list2}
...
\begin{list2}
  ...
  Quantitative Genetics modeling as a basis of animal and plant breeding % 動植物の選抜育種を支える量的遺伝モデリング
\end{list2}
...
\begin{list2}
  ...
  Faculty of Agriculture \\ %農学部 
  Design of experiments % 圃場試験実習、試験区設定
\end{list2}
...
\vspace{0.4cm}
 ...
 Practical applications of effective data-driven breeding % 具体的な応用例 - データ駆動型による効率的・効果的な農業・育種
\end{list2}
