...
\begin{list1}
  ...
  \item  [{\bf 87}.] Bi Y, Huang Y, Xuan J, and \textbf{\underline{Morota G}}. Industry-scale prediction of video-derived pig body weight using efficient convolutional neural networks and vision transformers. \emph{Biosystems Engineering}. In press. 
