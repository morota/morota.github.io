...
Zhang Z, Ha DS, Morota G, and Shin S. Behavior-specific filtering for enhanced pig behavior classification in precision livestock farming. 12th International Conference on Signal, Image Processing and Multimedia (SPM 2025). Toronto, Canada. July 19-20, 2025. 


  Bharadwaj S, Ranjan P, Pei Y, Yim J, Bi Y,  Ha D, Morota G, and Shin S. 2025. Non-invasive pig weight prediction using SAM-enhanced deep learning and depth imaging. SoutheastCon25. Embassy Suites Concord, Charlotte/Concord, NC. March 22-23, 2025


  Silva CM,  Signorini VS,  Mezzomo HC, Ribeiro JPO, Lima GW, Portes MF, Corredo LP, Olivoto T, Morota G, and Nardino M. Optimizing indirect selection of tropical wheat genotypes using high-throughput longitudinal phenotyping and trait relationships. 
...
Sahoo, MM Tarshish R, Sabag I, Gadri Y,  Morota G,  Peleg Z, Alchanatis V, and Herrmann I. Sesame yield prediction using UAV-borne hyperspectral imagery, crop traits and genotype category ECPA 2025.　
  ...
  Habimana V, Nguluma AS, Nziku ZC, Ekine-Dzivenu CC, Morota G, Mrode R, and Chenyambuga SW. Assessing genetic variation and phylogenetic relationship of dairy cattle breeds reared in Tanga region, Tanzania using HSF1 and HSPA6 genes responsible for heat tolerance.　East African Journal of Science, Technology and Innovation
   ...
   \item [{\bf 47}.] Morales AG, Amorim ST, Lizana C,  Pulido RG, Hanigan MD, Cockrum RR, and G. Morota. Incorporating heterosis effects enhances genetic evaluations for milk production and functional traits in Chilean crossbred dairy cows. 

  \item [{\bf 47}.] Liao M, Morota G, Bi Y, and Cockrum RR. Predicting dairy calf body weight using YOLOv8 and threshold segmentation: cross-validation and longitudinal analysis
