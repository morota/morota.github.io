...
\begin{list1}
 ...
 \item  [{\bf 67}.] Kadlec R, Indest S, Castro K, Waqar S, Campos LM, Amorim ST, Bi Y, Hanigan MD, and \textbf{\underline{Morota G}}. 2022. Automated acquisition of top-view dairy cow depth image data using an RGB-D sensor camera.    

       \vspace{0.5cm}


\item  [{\bf 66}.] Suela MM, Azevedo CF, Nascimento ACC, Momen M, Caixeta ET, \textbf{\underline{Morota G}}, and Nascimento M. 2022. Genome-wide association study for morphological, physiological, and productive traits in Coffea arabica using structural equation models. 

      \vspace{0.5cm}


\item  [{\bf 65}.] Wang Z, Yu D, \textbf{\underline{Morota G}}, Dhakal K, Singer W, Lord N, Huang H, Chen P, Mozzoni L, Li S, and Zhang B. 2023. Genome-wide association analysis of sucrose and alanine contents in edamame bean.      

      \vspace{0.5cm}

\item  [{\bf 64}.] Sandhu J, Irvin L, Chandaran AK, Paul P, Dhatt B, Hussain W, Cunningham S, Quinones C, Lorence A, Adviento-Borbe MA, Staswick P, \textbf{\underline{Morota G}}, and Walia H. 2022. Natural variation in {\it LONELY GUY-like 1} regulates rice grain weight under warmer nights.     
...
\begin{list1}
  ...
  \item [{\bf 64}.] Sabag I, Bi Y, Peleg Z, and \textbf{\underline{Morota G}}. Multi-environment analysis enhances genomic prediction accuracy of agronomic traits in sesame. \emph{bioRxiv}. doi: \textcolor{blue}{\href{https://doi.org/10.1101/2022.11.26.518043}{10.1101/2022.11.26.518043}}  
